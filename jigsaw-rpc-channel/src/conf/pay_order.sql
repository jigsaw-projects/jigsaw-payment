...
Source Server         : jigsaw-payment
Source Server Version : 50719
Source Host           : localhost:3306
Source Database       : jigsaw-payment

Target Server Type    : MYSQL
Target Server Version : 50719
File Encoding         : 65001

Date: 2017-08-10 19:19:42
*/
...
CREATE TABLE `pay_order_0` (
  `id` bigint(20) NOT NULL COMMENT '自增ID,兼容遗留数据',
  `code` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '交易流水号',
  `version` bigint(20) NOT NULL DEFAULT '0',
  `app_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '发起交易的app id',
  `pay_scenarios` int(4) NOT NULL COMMENT '发起交易的场景，包括api, 通用收银台，充值收银台，扫码支付等',
  ...
  `status` int(9) NOT NULL COMMENT '订单状态  1：已支付;2:未支付;3:等待中;4:退单;5:短信支付扣费成功;6:冻结;7:关闭',
  ...
  `pay_mode` tinyint(10) NOT NULL COMMENT '0.正常订单，1.代表测试订单',
  ...
  PRIMARY KEY (`code`),
  KEY `idx_pay_uid_time` (`sub_id`,`create_time`)
