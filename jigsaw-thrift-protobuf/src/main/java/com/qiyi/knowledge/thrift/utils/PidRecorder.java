/*
 * PidRecorder.java 1.0 2013/07/03
 *
 * Copyright (c) 2013 qiyi inc.
 */
...
/**
 * This class used to record pid of current process.
 * @author wangchuanqian
 *
 */
...
public class PidRecorder {
    ...
    /**
     * Fetch pid from the info string that contains the pid, but the pid info string
     * maybe is not the same.
     * For example: the pidInfo maybe is in one of those situations:
     *  1: GNU libgcj 4.4.7 20120313 (Red Hat 4.4.7-3) [10600
     *  2: 32199
     * @param pidInfo
     * @return
     */
     ...
     * @param pidInfo
     * @return
     *     the index of the last occurrence of the non-numeric character
