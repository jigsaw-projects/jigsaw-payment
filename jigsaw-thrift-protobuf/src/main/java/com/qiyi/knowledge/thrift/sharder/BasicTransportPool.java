...
public class BasicTransportPool extends RefreshableTransportPool {
    private static Logger LOG = Logger.getLogger(BasicTransportPool.class);
    /**
     * 可用的server队列的最多个数
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.qiyi.knowledge.thrift.sharder.RefreshableTransportPool#
     ...
     * (non-Javadoc)
     * @see
     * com.qiyi.knowledge.thrift.sharder.AbstractTransportPool#markError(org
