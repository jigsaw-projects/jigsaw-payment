...
public abstract class AbstractTransportPool extends
    ...
    private static Logger LOG = Logger.getLogger(AbstractTransportPool.class);
    /**
     ...
     * </ol>
     * @author <a href="mailto:lixiongfeng@qiyi.com">Li Xiongfeng</a>
     *
     */
    public class ManagedTransport extends TTransportWrapper {
         ...
         *
         * @see
         * com.qiyi.knowledge.thrift.sharder.TTransportWrapper#onException(java
         * .lang.Exception)
         */
        @Override
